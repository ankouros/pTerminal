...
| PT-012 | feature | medium | open | Window should stay active with a tray icon/menu that lets you show/hide the UI and exit with confirmation. | `internal/ui/window.go`, `internal/ui/tray_linux.go`, `docs/usage.md`, `README.md` |
...
| PT-014 | feature | medium | open | GitHub release awareness + “Check updates” / “Install update” buttons can download and install the latest portable bundle when a newer version is published. | `internal/update`, `internal/ui/window.go`, `internal/ui/assets/index.html`, `internal/ui/assets/app.js`, `internal/ui/assets/app.css`, `README.md`, `docs/usage.md` |
